""" Mapping functions between objects of two different Feeds. """
import pandas as pd
...
class FeedMapper:
    ...
    def map(self) -> None:
        ...
        # Usually there is no need to reduce feed2,
        # because it is generated by pdf2gtfs and should thus be minimal,
        # in the sense that it only contains mapped stops.
        # However, sometimes there are outliers from unrecognized connections.
